...
def process_image(image, model, reader):
    """Detects plates in an image, runs recognition, and draws results."""
    valid_detections = []
    invalid_detections = []
...
# This file handles all the heavy lifting: loading models, running inference, and processing images.